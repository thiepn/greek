...
dp.serializeBackup=(storage,options={})=>{const text=originalSerialize(storage,options),backup=JSON.parse(text);if(options.appVersion==='v1.11-feature'||backup.stores?.[KEY]!==undefined)backup.appVersion='v1.11-feature';return JSON.stringify(backup,null,2)};
