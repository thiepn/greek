...
(function rankBands(){assert.equal(band(100),'F1');assert.equal(band(101),'F2');assert.equal(band(601),'F4');assert.equal(unitForRank(20),4);assert.equal(unitForRank(1000),50)})();
