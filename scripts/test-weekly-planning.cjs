...
assert.ok(html.includes('id="weekly-plan"'));assert.ok(html.includes('id="milestones-forecast"'));assert.ok(html.indexOf('session-engine.js')<html.indexOf('weekly-planning-engine.js'));assert.ok(html.indexOf('session-ui.js')<html.indexOf('weekly-planning-ui.js'));assert.ok(dpui.includes("appVersion:'v1.5-feature'"));
