...
const diagnostics={};
for(const path of ['course-ui.js','pwa-manager.js','manifest.webmanifest','RELEASE_CANDIDATE.json','generated/pwa-version.js','generated/corpus/manifest.json','generated/corpus/books/John.json']){
  diagnostics[path]=await probe(path);
}
console.log('root_has_course_ui:',html.text.includes('course-ui.js'));
console.log('root_has_pwa_manager:',html.text.includes('pwa-manager.js'));
